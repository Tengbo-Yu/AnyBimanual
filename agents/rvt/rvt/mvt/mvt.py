...
from agents.rvt.rvt.mvt.mvt_single import MVT as MVTSingle
from agents.rvt.rvt.mvt.config import get_cfg_defaults
from agents.rvt.rvt.mvt.renderer import BoxRenderer
...
class MVT(nn.Module):
    def __init__(
        ...
        if self.use_point_renderer:
            from agents.rvt.rvt.point_renderer.rvt_renderer import RVTBoxRenderer as BoxRenderer
        else:
            from agents.rvt.rvt.mvt.renderer import BoxRenderer
        global BoxRenderer
