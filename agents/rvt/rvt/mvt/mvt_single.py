...
from agents.rvt.rvt.mvt.attn import (
    Conv2DBlock,
    Conv2DUpsampleBlock,
    PreNorm,
    Attention,
...
from agents.rvt.rvt.mvt.raft_utils import ConvexUpSample
...
class MVT(nn.Module):
    def __init__(
        ...
        if self.use_point_renderer:
            ...
            from agents.rvt.rvt.mvt.renderer import select_feat_from_hm
